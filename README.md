...
| GoogleDrive - Projects Dir | LeanVision: 1-page roadmap, product plan, success scenarios & user stories |  A spreadsheet with 4 sheets:  Roadmap communicates the products and sequence of they fit into the big vision. Product plan communicates the project goal, status, budget and major tasks for our current scope of work.   Success scenarios communicate is a narrative of what a successful overall user experience will be from the perspective of each user role.   User stories communicates desired outcomes from a user perspective relating to the major tasks in product plan and should reference the success scenarios and concept wireframes | Updated as frequently as necessary |
